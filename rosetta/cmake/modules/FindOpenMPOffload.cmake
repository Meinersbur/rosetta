...
# Inputs: OpenMPOffload_FIND_VERSION OpenMPOffload_FIND_QUIETLY
# OpenMPOffload_FIND_REQUIRED

# Outputs: OpenMPOffload_FOUND OpenMPOffload_DEFINITIONS OpenMPOffload import
# target
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  ...
  # set(OPENMP_OFFLOADING_CFLAGS  "-foffload=default" CACHE STRING "Compiler
  # arguments for OpenMP offloading") set(OPENMP_OFFLOADING_LDFLAGS
  # "-foffload=default" CACHE STRING "Linker arguments for OpenMP offloading")
  # Look for OFFLOAD_TARGET_NAMES in `g++ -v` to get otpions

  # CUDA doesn't like extra protections that gcc adds by default
  # (-foffload=nvptx-none=\"-fcf-protection=none -fno-stack-protector\"
  # -fno-stack-protector) -no-pie:
  # https://bugs.launchpad.net/ubuntu/+source/gcc-10/+bug/1907812 TODO:
  # Introspection
...
set(CMAKE_REQUIRED_LINK_OPTIONS ${_offload_openmp_flags}
...
if(HAVE_PRAGMA_OMP_TARGET)
  ...
  set_property(TARGET OpenMP::OpenMP_Offload_CXX
               PROPERTY INTERFACE_COMPILE_OPTIONS ${_offload_required_cflags})
  set_property(
    TARGET OpenMP::OpenMP_Offload_CXX
    PROPERTY INTERFACE_LINK_OPTIONS ${_offload_openmp_flags}
             ${_offload_required_ldflags}) # FIXME: OpenMP_CXX_FLAGS (-fopenmp)
                                           # already be added by
  ...
  set_property(TARGET OpenMP::OpenMP_Offload_C
               PROPERTY INTERFACE_COMPILE_OPTIONS ${_offload_required_cflags})
  set_property(
    TARGET OpenMP::OpenMP_Offload_C
    PROPERTY INTERFACE_LINK_OPTIONS ${_offload_openmp_flags}
             ${_offload_required_ldflags})
