...
def results_compare(resultfiles: list, compare_by, group_by=None, compare_val=None, show_groups=None):
    ...
    print_comparison(groups_of_results=grouped_results, list_of_resultnames=all_cmpvals,
                     common_columns=show_groups or div_groups, compare_columns=compare_val)
...
def runner_main_run(srcdir, builddir):
    with globalctxmgr:
        ...
        subcommand_run(None, args, srcdir, builddirs=[
