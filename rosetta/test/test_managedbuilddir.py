...
class ManagedBuilddirDefaultconfig(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        rosetta.driver.driver_main(argv=[None, '--configure', '--cmake-def=ROSETTA_BENCH_FILTER=--filter-include-program-exact=idioms.assign', '--cmake-def=ROSETTA_PPM_DEFAULT=OFF', '--cmake-def=ROSETTA_PPM_SERIAL=ON'], mode=DriverMode.MANAGEDBUILDDIR, rootdir=cls.rootdir, srcdir=cls.srcdir  )
