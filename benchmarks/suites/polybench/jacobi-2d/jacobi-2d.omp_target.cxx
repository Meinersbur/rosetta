...
#pragma omp target data map(to:pA[0:n*n])  map(from:pB[0:n*n]) 
  {
...
#pragma omp target teams distribute parallel for collapse(2) dist_schedule(static) schedule(static) default(none) firstprivate(tsteps, n, pA, pB)
